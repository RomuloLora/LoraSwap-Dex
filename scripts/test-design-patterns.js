...
async function main() {
    console.log("🏗️ Testando Design Patterns em Solidity\n");
    ...
    console.log("   Pool criado via factory:", newPool);
    ...
    // 3. TESTE: Diamond Pattern
    console.log("💎 Teste 3: Diamond Pattern");
    ...
    // Deploy do Diamond
    const LoraDiamond = await ethers.getContractFactory("LoraDiamond");
    const diamond = await LoraDiamond.deploy(
        owner.address,
        await diamondCutFacet.getAddress()
    );
    await diamond.waitForDeployment();
    console.log("✅ LoraDiamond deployado:", await diamond.getAddress());
    console.log("");

    // 4. TESTE: Registry Pattern
    console.log("📋 Teste 4: Registry Pattern");
    ...
    // 5. TESTE: Strategy Pattern
    console.log("🎯 Teste 5: Strategy Pattern");
    ...
    console.log("🎉 Todos os Design Patterns testados com sucesso!");
    ...
    console.log("   ✅ Diamond Pattern - Modularidade avançada (EIP-2535)");
    console.log("   ✅ Registry Pattern - Discovery de pools e serviços");
    console.log("   ✅ Strategy Pattern - Algoritmos de pricing flexíveis");
    console.log("");
    console.log("🚀 LoraSwap-DEX agora possui uma arquitetura robusta e modular!");
    ...
    console.log("   - Diamond: Modularidade extrema");
